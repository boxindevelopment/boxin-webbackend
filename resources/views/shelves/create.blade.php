...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Add Shelf</h3>
    </div>
</div>
<!-- ============================================================== -->
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
              ...
              <form action="{{ route('shelves.store') }}" method="POST" enctype="application/x-www-form-urlencoded">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="code_shelves" id="code_shelves" required readonly>
                      </div>
