    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
              ...
              <h4 class="card-title"><span class="lstick"></span>Edit Shelf</h4>

              <form action="{{ route('shelves.update', ['id' => $id]) }}" method="POST" enctype="application/x-www-form-urlencoded">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="area_id" name="area_id" value="{{ $shelves->area_id }}##{{ $shelves->area_id_name }}" required>
                      </div>
