...
$(function() {
    ...
    function action(id){
        var $action = '<a class="btn btn-info btn-sm" href="{{route('change-box.index')}}/' + id + '/edit" title="Edit" style="margin-right:5px;"><i class="fa fa-pencil"></i></a>';
        return $action;
    }
