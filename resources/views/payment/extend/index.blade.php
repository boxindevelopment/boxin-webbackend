...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
              <h4 class="card-title"><span class="lstick"></span>List Extend Order Payments</h4>
...
$(function() {
    ...
    function action(id){
        var $action = '<a class="btn btn-primary btn-sm" href="{{url('order-details')}}/' + id + '" title="View Order Detail"" style="margin-right:5px;"><i class="fa fa-eye"></i></a>';
            $action += '<a class="btn btn-info btn-sm" href="{{route('payment.extend')}}/' + id + '" title="Edit" style="margin-right:5px;"><i class="fa fa-pencil"></i></a>';
        // var $action = '<form action="{{route('payment.extend')}}' + id + '" method="post" style="margin-top:5px;">';
        //         $action += '@csrf';
