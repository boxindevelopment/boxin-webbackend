                      ...
                      @if(count($data) > 0)
                        @foreach ($data as $key => $value)
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              <a class="btn btn-primary btn-sm" href="{{route('orderDetail.detail', ['id' => $value->order_detail_id])}}" title="View Order Detail"><i class="fa fa-eye"></i></a>
                              <a class="btn btn-info btn-sm" href="{{route('payment.extend.edit', ['id' => $value->id])}}" title="Edit"><i class="fa fa-pencil"></i></a>
                            </td>
                          </tr>
                        @endforeach
                      @else
