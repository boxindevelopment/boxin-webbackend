    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
              ...
              <form action="{{ route('payment.extend.update', ['id' => $id]) }}" method="POST" enctype="application/x-www-form-urlencoded">
                @csrf
                @method('PUT')
                <div class="row el-element-overlay">
                  @foreach ($data as $key => $value)
                  @php
                    $url = 'https://boxin-dev-order.azurewebsites.net/images/payment/order/detail/';
                  @endphp
                    <div class="col-md-6">
                        <div class="card">
                    ...
                    <div class="col-md-6">
                      ...
                      @endif
                      <input type="hidden" name="extend_id" class="form-control" value="{{ $value->extend_id }}" required>

                      <a href="{{ route('payment.extend') }}" class="btn btn-secondary waves-effect waves-light m-r-10">Back</a>
