    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body collapse show">
              ...
              <form action="{{ route('city.store') }}" method="POST" enctype="application/x-www-form-urlencoded">
                @csrf
                <div class="row">
                    <div class="col-md-6">
    ...
    <div class="col-12">
      <div class="card">
          <div class="card-body">
            ...
            <h4 class="card-title"><span class="lstick"></span>List Cities</h4>
                      ...
                      @foreach ($city as $key => $value)
                        <tr>
                          ...
                          <td class="text-center">
                            <form action="{{route('city.destroy', ['id' => $value->id])}}" method="post">
                              @csrf
                              <a class="btn btn-info btn-sm" href="{{route('city.edit', ['id' => $value->id])}}" title="Edit"><i class="fa fa-pencil"></i> </a>
                              @method('DELETE')
