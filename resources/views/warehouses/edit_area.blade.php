    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
              ...
              <h4 class="card-title"><span class="lstick"></span>Edit Warehouse Areas</h4>

              <form action="{{ route('warehouses-area.update', ['id' => $id]) }}" method="POST" enctype="application/x-www-form-urlencoded">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">

                      <input type="text" name="id_name_area" id="id_name_area" value="{{ $area->id_name }}" required>
