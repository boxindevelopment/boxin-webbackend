...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body collapse show">
              ...
              <form action="{{ route('user.finance.store') }}" method="POST" enctype="application/x-www-form-urlencoded">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="finance_id" name="finance_id" required>
                      </div>  
                      <div class="form-group">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
              <h4 class="card-title"><span class="lstick"></span>List Admin Finance</h4>  
