...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">List Admin Area</h3>
    </div>
</div>
<!-- ============================================================== -->
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
              ...
              <h4 class="card-title"><span class="lstick"></span>Edit Admin Area</h4>
                ...
                <div class="row">
                    <div class="col-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="admin_id" name="admin_id" value="{{ $user->user_id }}" required>
                      </div>
                      ...
                      <hr>
                      <a href="{{ route('user.admin.index') }}" class="btn btn-secondary waves-effect waves-light m-r-10">Back</a>
