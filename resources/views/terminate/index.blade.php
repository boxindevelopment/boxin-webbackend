                  ...
                  <table id="table-data1" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                          ...
                          <th width="20%" class="text-center">Terminate Date</th>
...
$(function() {
    ...
    function action(id){
        var $action = '<a class="btn btn-info btn-sm" href="{{route('terminate.index')}}/' + id + '/edit" title="Edit" style="margin-right:5px;"><i class="fa fa-pencil"></i></a>';
        return $action;
    }
