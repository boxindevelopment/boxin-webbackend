    ...
    <div class="col-lg-4">
        <div class="card bg-info text-white">
            <div class="card-body">
                <div class="d-flex">
                    <div class="stats">
                        <h1 class="text-white">{{$takeToday}}</h1>
                        <h6 class="text-white">Take Request Today</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-4">
        <div class="card bg-primary text-white">
            <div class="card-body">
                <div class="d-flex">
                    <div class="stats">
                        <h1 class="text-white">{{$takeAll}}</h1>
                        <h6 class="text-white">Take Request All</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-4">
        <div class="card bg-success text-white">
            <div class="card-body">
                <div class="d-flex">
                    <div class="stats">
                        <h1 class="text-white">{{$takeSuccess}}</h1>
                        <h6 class="text-white">Take Success All</h6>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
              <h4 class="card-title"><span class="lstick"></span>Take Box</h4>
                  ...
                  <table id="table-data1" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                          ...
                          <th width="20%" class="text-center">Take Date</th>
...
$(function() {
    ...
    function action(id){
        var $action = '<a class="btn btn-info btn-sm" href="{{route('take.index')}}/' + id + '/edit" title="Edit" style="margin-right:5px;"><i class="fa fa-pencil"></i></a>';
        return $action;
    }
