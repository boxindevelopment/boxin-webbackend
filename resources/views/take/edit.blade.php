...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Take Boxes</h3>
    </div>
</div>
<!-- ============================================================== -->
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
              ...
              <h4 class="card-title"><span class="lstick"></span>Edit Take Boxes</h4>
...
$(function() {
  ...
  $('#btn_save_date').on('click', function(){
    ...
    $.post("{{ route('take.updateDate', ['id' => $id]) }}",
    {
    ...
    function(data, status){
      ...
      window.location.href = "{{ route('take.edit', ['id' => $id]) }}";
    });
  });
