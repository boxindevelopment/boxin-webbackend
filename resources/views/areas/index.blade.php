    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body collapse show">
              ...
              <form action="{{ route('area.store') }}" method="POST" enctype="application/x-www-form-urlencoded">
                @csrf
                <div class="row">
                    <div class="col-md-6">
    ...
    <div class="col-12">
      <div class="card">
          <div class="card-body">
            ...
            <h4 class="card-title"><span class="lstick"></span>List Areas</h4>
                      ...
                      @foreach ($area as $key => $value)
                        <tr>
                          ...
                          <td class="text-center">
                            <form action="{{route('area.destroy', ['id' => $value->id])}}" method="post">
                              @csrf
                              <a class="btn btn-info btn-sm" href="{{route('area.edit', ['id' => $value->id])}}"><i class="fa fa-pencil"></i></a>
                              @method('DELETE')
