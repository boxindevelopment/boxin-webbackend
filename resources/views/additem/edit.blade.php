                                  ...
                                  <div class="card-body collapse show">
                                      ...
                                      @if(isset($value->order_detail->types_of_box_room_id))
                                          ...
                                          <div class="form-material row">
                                              ...
                                              <div class="form-group col-md-4">
                                                  <input type="text" class="form-control form-control-line" value="{{date('d M Y', strtotime($value->order_detail->date))}} {{ $value->order_detail->time_pickup ? '('.$value->order_detail->time_pickup.')' : '' }}" readonly> </div>
