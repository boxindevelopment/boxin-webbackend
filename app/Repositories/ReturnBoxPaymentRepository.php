...
class ReturnBoxPaymentRepository implements ReturnBoxPaymentRepositoryInterface
{
    ...
    public function all()
    {
        ...
        $data = $data->select('return_box_payments.id', 'return_box_payments.return_boxes_id', 'return_box_payments.status_id', 'return_box_payments.id_name', 'return_box_payments.created_at', 'users.first_name',  'users.last_name');
        $data = $data->leftJoin('return_boxes','return_boxes.id','=','return_box_payments.return_boxes_id');
