...
class ChangeBoxPaymentRepository implements ChangeBoxPaymentRepositoryInterface
{
    ...
    public function all()
    {
        ...
        $data = $data->select('change_box_payments.id', 'change_box_payments.order_detail_id', 'change_box_payments.status_id', 'change_box_payments.id_name', 'change_box_payments.created_at', 'users.first_name',  'users.last_name');
